...
static void ImGui_ImplSDL2_GetWindowSizeAndFramebufferScale(SDL_Window* window, SDL_Renderer* renderer, ImVec2* out_size, ImVec2* out_framebuffer_scale)
{
    ...
    if (out_framebuffer_scale != nullptr)
      //*out_framebuffer_scale = (w > 0 && h > 0) ? ImVec2((float)display_w / w, (float)display_h / h) : ImVec2(1.0f, 1.0f); // Something gopes wrong here. SDL_GetRendererOutputSize returns values less than WindowSize in my systrem
